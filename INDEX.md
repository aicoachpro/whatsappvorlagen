...
- [SYSTEM_ARCHITECTURE.md](SYSTEM_ARCHITECTURE.md) — System-Architektur + Superchat-/PocketBase-Schema
...
## Specs
- [specs/VPS_PLATTFORM_KONZEPT.md](specs/VPS_PLATTFORM_KONZEPT.md) — historisches Konzept der Notion-Ablösung (abgeschlossen mit VOE-242), Tenancy-Modell A
...
- `agents/` — Superchat→PocketBase-Sync, Datenqualität, PocketBase-Setup, Tenant-Lifecycle, Self-Healing, Previews
