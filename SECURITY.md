...
| `WHATSAPP_ACCESS_TOKEN` | `.env` (lokal) | im Chat, Logs, Git |
| `WHATSAPP_PHONE_NUMBER_ID` | `.env` (lokal) | im Chat, Logs, Git |
...
|-----------|-------|------------|
| Token-Leak (WhatsApp/Notion) | API-Credentials | Env-only, Logs-Sanitizer, Rotation alle 90 Tage |
