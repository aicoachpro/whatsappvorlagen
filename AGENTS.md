...
1. [CONVENTIONS.md](CONVENTIONS.md) — Runtime, Backlog-Adapter (Linear `VOE-`), Governance-Modus `lite`, aktive Gates
...
- Kein Code ohne Linear-Issue (Team „Voelker AI Solutions", Prefix `VOE-`, Label `wavs`).
